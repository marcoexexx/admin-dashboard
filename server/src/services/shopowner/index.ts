 ...
 */
export class ShopownerService extends MetaAppService implements AppService {
  private repository = db.shopownerProvider

  constructor() {
    super(Resource.Shopowner, { action: OperationAction.Read, resourceIds: [] })
  }
   ...
   */
  static new() { return new ShopownerService() }
  ...
  > {
    ...
    const opts = async (brand: CreateMultiShopownersInput[number]) => {
