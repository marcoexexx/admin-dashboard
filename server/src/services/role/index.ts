 ...
 */
export class RoleService extends MetaAppService implements AppService {
  private repository = db.role

  constructor() {
    super(Resource.Role, { action: OperationAction.Read, resourceIds: [] })
  }
   ...
   */
  static new() { return new RoleService() }
  ...
  > {
    ...
    const opts = async (brand: CreateMultiRolesInput[number]) => {
