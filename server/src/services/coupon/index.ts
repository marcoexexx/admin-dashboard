...
export class CouponService implements AppService {
  ...
  async create(payload: Prisma.CouponCreateInput): Promise<Result<Coupon, AppError>> {
  ...
  async update(arg: { filter: Prisma.CouponWhereUniqueInput; payload: Prisma.CouponUpdateInput; }): Promise<Result<Coupon, AppError>> {
