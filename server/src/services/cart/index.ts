...
/**
 * CartService class provides methods for managing cart data.
 *
 * @remarks
 * This class implements the AppService interface and is designed to handle operations related to carts.
 */
export class CartService extends MetaAppService implements AppService {
  private repository = db.cart

  constructor() {
    super(Resource.Cart, { action: OperationAction.Read, resourceIds: [] })
  }
   ...
   */
  static new() { return new CartService() }
