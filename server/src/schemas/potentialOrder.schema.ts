...
export const createPotentialOrderSchema = object({
  body: object({
    ...
    status: z.nativeEnum(PotentialOrderStatus).default(
      PotentialOrderStatus.Processing,
    ),
...
export type GetPotentialOrderInput = z.infer<
  typeof getPotentialOrderSchema
>;
export type CreatePotentialOrderInput = z.infer<
  typeof createPotentialOrderSchema
>["body"];
export type DeleteMultiPotentialOrdersInput = z.infer<
  typeof deleteMultiPotentialOrdersSchema
>["body"];
export type UpdatePotentialOrderInput = z.infer<
  typeof updatePotentialOrderSchema
>;
