...
export type CreateMultiPermissionsInput = z.infer<typeof createMultiPermissionsSchema>["body"]
export type DeleteMultiPermissionsInput = z.infer<typeof deleteMultiPermissionsSchema>["body"]
