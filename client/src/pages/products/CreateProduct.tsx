  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Create products effortlessly with our user-friendly platform. Streamline customization and showcase your offerings seamlessly. Start crafting your unique products today."
        >
        </meta>
      </Helmet>
