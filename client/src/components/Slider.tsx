...
//   ({ theme }) => `
//         width: ${theme.colors.layout.sidebar.width};
//         min-width: ${theme.colors.layout.sidebar.width};
//         color: ${theme.colors.alpha.trueWhite[70]};
//         position: relative;
//         z-index: 7;
//         height: 100%;
...
// export function Slider() {
//   const { state: {slidebar}, dispatch } = useStore()

//   const sidebarToggle = slidebar
//   const toggleSidebar = () => dispatch({ type: "TOGGLE_SLIDEBAR" })
...
//               : darken(theme.colors.alpha.black[100], 0.5),
//           boxShadow:
//             theme.palette.mode === 'dark' ? theme.colors.layout.sidebar.boxShadow : 'none'
//         }}
//       >
//         <Box>
//           <Box mt={3}>
